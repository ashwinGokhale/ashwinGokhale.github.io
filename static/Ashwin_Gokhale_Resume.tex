...
\vspace{1mm}
\begin{tabular}{ l l }
    \textbf{Proficient:} & JavaScript, TypeScript, React.js, HTML, Java, Python, C\#, SQL Server, Nx, Azure \\
...
\textbf{Microsoft} \hfill Redmond, WA / Remote\\
\textit{Software Engineer 2} \hfill February 2020 -- Present\\
\vspace{-1mm}
\begin{itemize} \itemsep 1pt
    \item Led feature development team of 5 junior engineers for rewrite of most visited page (65K DAU / 600K daily page views) from Angular.js to React, leading to 27\% less runtime errors, 73\% load time decrease, and 96\% increase in customer satisfaction score
    \item Sole tech lead for scaling out monorepo from single legacy Angular application to 13 React microfrontend applications, owned by 9 teams (75 engineers total) using Nx and Webpack module federation
\end{itemize}
